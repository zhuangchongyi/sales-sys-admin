<template>
    <div class="container">
        ...
        <el-table v-loading="loading" :data="clienteleList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="客户联系人" align="center" prop="linkman" width="100"></el-table-column>
            <el-table-column label="联系人电话" align="center" prop="clientelePhone" width="150"></el-table-column>
            <el-table-column label="手机" align="center" prop="mobilePhone" width="150"></el-table-column>
            <el-table-column label="业务员" prop="personnelName" align="center" width="100"></el-table-column>
            <el-table-column label="业务部门" prop="deptName" align="center" width="100"></el-table-column>
            <el-table-column label="单位" align="center" prop="dw" width="300"></el-table-column>
            <el-table-column label="交期" align="center" prop="time" width="160"></el-table-column>
            ...
            <el-table-column label="技术要求" align="center" prop="payType" width="160"></el-table-column>
