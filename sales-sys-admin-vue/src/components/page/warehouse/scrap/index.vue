<template>
    <div class="container">
        <el-form :model="queryParams" ref="queryParams" :inline="true">
            <el-form-item label="仓库编码" prop="clienteleNum">
                <el-input v-model="queryParams.clienteleNum" placeholder="请输入仓库编码" clearable size="small" style="width: 200px" @keyup.enter.native="handleQuery" />
            </el-form-item>
        ...
        <el-table v-loading="loading" :data="clienteleList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="编号" align="center" prop="clienteleId" />
            <el-table-column label="单价" align="center" prop="clienteleName" :show-overflow-tooltip="true"   />
            <el-table-column label="单位" align="center" prop="clienteleTypeName" :show-overflow-tooltip="true"   />
            <el-table-column label="报废数量" align="center" prop="linkman" ></el-table-column>
            <el-table-column label="型号规格" align="center" prop="deptName"></el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="报废数量" prop="nickName"><el-input v-model="form.nickName" placeholder="请输入报废数量" /></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="型号规格" prop="phonenumber"><el-input v-model="form.phonenumber" placeholder="请输入手机号码" maxlength="11" /></el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="单位" prop="clienteleName">
                            <el-input v-model="form.clienteleName" placeholder="请输入单位" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="创建时间" prop="createTime"><el-input v-model="form.createTime" placeholder="请输入商品名称" /></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
    ...
    data() {
        return {
            ...
            rules: {
                ...
                nickName: [{ required: true, message: '商品名称不能为空', trigger: 'blur' }],
