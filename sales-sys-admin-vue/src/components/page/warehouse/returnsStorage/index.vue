    ...
    <div>
        <div class="container">
            ...
            <div class="handle-box">
                ...
                <el-button type="warning" size="mini" icon="el-icon-finished" class="handle-del mr10" :disabled="multiple" @click="handleAudit">生成退款单</el-button>
            ...
            <el-table :data="tableData" class="table" ref="multipleTable" header-cell-class-name="table-header" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="deptName" label="退货单位" align="center"></el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="退入仓库" prop="warehouseName"><el-input v-model="form.warehouseName" placeholder="请输入退入仓库" maxlength="50" /></el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退货单位" prop="deptName"><el-input v-model="form.deptName" placeholder="请输入退货单位" maxlength="50" /></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="金额"><el-input v-model="form.remark" type="text" placeholder="请输入金额"></el-input></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="商品编码" prop="clienteleName">
                            <el-input v-model="form.clienteleName" placeholder="请输入商品编码" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="入库日期" prop="createTime"><el-input v-model="form.createTime" type="date" /></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
