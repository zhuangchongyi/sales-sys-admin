        ...
        <el-row :gutter="20">
            ...
            <el-col :span="4" :xs="24">
                <div class="head-container">
                    <el-input v-model="deptName" placeholder="请输入客户类别名称" clearable size="small" prefix-icon="el-icon-search" style="margin-bottom: 20px" />
                </div>
                <div class="head-container">
                    <el-tree
                        :data="deptOptions"
            ...
            <el-col :span="20" :xs="24">
                ...
                <el-table v-loading="loading" :data="clienteleList" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column prop="personnelName" label="经营业务员" align="center" width="100"></el-table-column>
                    <el-table-column prop="deptName" label="归属部门" align="center" width="100"></el-table-column>
                    <el-table-column label="状态" align="center">
                        <template slot-scope="scope">
                            <el-switch v-model="scope.row.status" active-value="0" inactive-value="1" @change="handleStatusChange(scope.row)"></el-switch>
                        </template>
                    </el-table-column>
                    <el-table-column prop="companyAddress" label="公司地址" align="center" width="300"></el-table-column>
                    <el-table-column label="创建时间" align="center" prop="createTime" width="160"></el-table-column>
                    <el-table-column label="操作" align="center" width="180" class-name="small-padding fixed-width" fixed="right">
                        <template slot-scope="scope">
                            <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)">修改</el-button>
                            <el-button size="mini" type="text" icon="el-icon-delete" @click="delRoleHandle(scope.row)">删除</el-button>
        ...
        <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="归属类别" prop="deptId">
                            <treeselect v-model="form.deptId" :options="deptOptions" :disable-branch-nodes="true" :show-count="true" placeholder="请选择归属类别" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="联系电话" prop="email"><el-input v-model="form.email" placeholder="请输入联系电话" maxlength="50" /></el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item v-if="form.userId == undefined" label="客户公司" prop="password">
                            <el-input v-model="form.password" placeholder="请输入客户公司" type="password" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
...
export default {
    ...
    methods: {
        ...
        handleStatusChange(row) {
            ...
            this.$confirm('确认要' + text + ' "' + row.clienteleName + '" 用户吗?', '警告', {
